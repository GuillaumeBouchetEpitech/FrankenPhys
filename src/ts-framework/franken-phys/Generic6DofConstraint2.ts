...
export class ConcreteGeneric6DofConstraint2 implements IGeneric6DofConstraint2 {

  public _rawConstraint: FrankenPhys.bjtsGeneric6DofSpring2Constraint;
  ...
  constructor(def: Generic6DofConstraint2Def) {
    ...
    this._rawConstraint = new bullet.bjtsGeneric6DofSpring2Constraint(
      rawRigidBodyA,
      rawRigidBodyB,
      newTransformA,
      newTransformB,
