...
export function renderRagDollWithDynamicConstrainedBox_broken(scene: THREE.Scene, physicWorld: physics.PhysicWorld): () => void {
  ...
  const k_origin: glm.ReadonlyVec3 = [-10,10,20];
  ...
  const _lowerMiddleConstraint = physicWorld.createGeneric6DofConstraint({
    bodyA: lowerChest,
    bodyB: midChest,
    frameA: [0,0,0.4],
    frameB: [0,0,0],
  ...
  const _middleUpperConstraint = physicWorld.createGeneric6DofConstraint({
    bodyA: midChest,
    bodyB: upperChest,
    frameA: [0,0,0.7],
    frameB: [0,0,0.0],
  ...
  const _upperNeckConstraint = physicWorld.createGeneric6DofConstraint({
    bodyA: upperChest,
    bodyB: neck,
    frameA: [0,0,1.0],
    frameB: [0,0,0.0],
  ...
  const _neckHeadConstraint = physicWorld.createGeneric6DofConstraint({
    bodyA: neck,
    bodyB: head,
    frameA: [0,0,0.6],
    frameB: [0,0,0.0],
  ...
  const leftArm = physicWorld.createRigidBody({
    ...
    position: [k_origin[0]+0,k_origin[1]+1,k_origin[2]+1.9],
    orientation: glm.quat.identity(glm.quat.create()),
    collisionFilterGroup: -1,
    collisionFilterMask: -4,
  });
  ...
  const _upperLeftArmConstraint = physicWorld.createGeneric6DofConstraint({
    bodyA: upperChest,
    bodyB: leftArm,
    frameA: [0,1,0.7],
    frameB: [0,0.0,0.0],
  ...
  const _leftArmLeftForearmConstraint = physicWorld.createGeneric6DofConstraint({
    bodyA: leftArm,
    bodyB: leftForearm,
    frameA: [0,1.4,0.0],
    frameB: [0,0.0,0.0],
  ...
  const _leftForearmLeftHandConstraint = physicWorld.createGeneric6DofConstraint({
    bodyA: leftForearm,
    bodyB: leftHand,
    frameA: [0,1.4,0.0],
    frameB: [0,0.0,0.0],
  ...
  const _upperRightArmConstraint = physicWorld.createGeneric6DofConstraint({
    bodyA: upperChest,
    bodyB: rightArm,
    frameA: [0,-1,0.7],
    frameB: [0,0.0,0.0],
  ...
  const _rightArmRightForearmConstraint = physicWorld.createGeneric6DofConstraint({
    bodyA: rightArm,
    bodyB: rightForearm,
    frameA: [0,-1.4,0.0],
    frameB: [0,0.0,0.0],
  ...
  const _rightForearmRightHandConstraint = physicWorld.createGeneric6DofConstraint({
    bodyA: rightForearm,
    bodyB: rightHand,
    frameA: [0,-1.4,0.0],
    frameB: [0,0.0,0.0],
  ...
  const _lowerLeftLegConstraint = physicWorld.createGeneric6DofConstraint({
    bodyA: lowerChest,
    bodyB: leftLeg,
    frameA: [0,+0.5,0.0],
    frameB: [0,0.0,0.0],
  ...
  const _leftLegLeftForeLegConstraint = physicWorld.createGeneric6DofConstraint({
    bodyA: leftLeg,
    bodyB: leftForeLeg,
    frameA: [0,0.0,-2.0],
    frameB: [0,0.0,0.0],
  ...
  const _leftForeLegLeftFootConstraint = physicWorld.createGeneric6DofConstraint({
    bodyA: leftForeLeg,
    bodyB: leftFoot,
    frameA: [0,0,-2.0],
    frameB: [0,0.0,0.0],
  ...
  const _lowerRightLegConstraint = physicWorld.createGeneric6DofConstraint({
    bodyA: lowerChest,
    bodyB: rightLeg,
    frameA: [0,-0.5,0.0],
    frameB: [0,0.0,0.0],
  ...
  const _rightLegRightForeLegConstraint = physicWorld.createGeneric6DofConstraint({
    bodyA: rightLeg,
    bodyB: rightForeLeg,
    frameA: [0,0.0,-2.0],
    frameB: [0,0.0,0.0],
  ...
  const _rightForeLegRightFootConstraint = physicWorld.createGeneric6DofConstraint({
    bodyA: rightForeLeg,
    bodyB: rightFoot,
    frameA: [0,0,-2.0],
    frameB: [0,0.0,0.0],
